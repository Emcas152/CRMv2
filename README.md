...
Este workspace incluye un backend PHP en `backend/` y scripts de instalación de base de datos (MySQL).

- Guía de instalación: [backend/docs/INSTALL.md](backend/docs/INSTALL.md)
- Script BD (PowerShell): `tools/install.ps1`
- Setup completo (npm + BD): `tools/setup.ps1`
